...
import com.diandson.service.PersonneService;
...
/**
 * REST controller for managing {@link com.diandson.domain.Personne}.
 */
@RestController
@RequestMapping("/api")
public class PersonneResource {
    ...
    public ResponseEntity<List<PersonneDTO>> getAllPersonnes(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
