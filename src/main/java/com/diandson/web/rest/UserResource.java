...
import com.diandson.service.MailService;
...
import com.diandson.web.rest.errors.EmailAlreadyUsedException;
import com.diandson.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
...
//    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.ADMIN + "\")")
    public ResponseEntity<List<AdminUserDTO>> getAllUsers(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        ...
        final List<AdminUserDTO> page = userService.getAllManagedUsers(pageable);
