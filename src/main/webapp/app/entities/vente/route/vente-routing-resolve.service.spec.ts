...
describe('Vente routing resolve service', () => {
  ...
  let resultVente: IVente | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IVente if id is not provided', () => {
      // GIVEN
      ...
      expect(resultVente).toEqual(new Vente());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Vente })));
      mockActivatedRouteSnapshot.params = { id: 123 };
