...
describe('TypePack Management Component', () => {
  let comp: TypePackComponent;
  let fixture: ComponentFixture<TypePackComponent>;
  let service: TypePackService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'type-pack', component: TypePackComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(TypePackComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.typePacks?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
