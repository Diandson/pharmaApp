...
describe('Assurance Management Component', () => {
  let comp: AssuranceComponent;
  let fixture: ComponentFixture<AssuranceComponent>;
  let service: AssuranceService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'assurance', component: AssuranceComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(AssuranceComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.assurances?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
