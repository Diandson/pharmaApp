...
describe('InventaireMedicament Management Component', () => {
  let comp: InventaireMedicamentComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'inventaire-medicament', component: InventaireMedicamentComponent }]),
      ...
      .overrideTemplate(InventaireMedicamentComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.inventaireMedicaments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
