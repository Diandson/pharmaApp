...
describe('Pack routing resolve service', () => {
  ...
  let resultPack: IPack | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IPack if id is not provided', () => {
      // GIVEN
      ...
      expect(resultPack).toEqual(new Pack());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Pack })));
      mockActivatedRouteSnapshot.params = { id: 123 };
