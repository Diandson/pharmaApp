...
describe('Pack Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pack', component: PackComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.packs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
