...
class CommandeResourceIT {
    ...
    public static Commande createEntity(EntityManager em) {
        Commande commande = new Commande().numero(DEFAULT_NUMERO).dateCommande(DEFAULT_DATE_COMMANDE);
        return commande;
    }
    ...
    public static Commande createUpdatedEntity(EntityManager em) {
        Commande commande = new Commande().numero(UPDATED_NUMERO).dateCommande(UPDATED_DATE_COMMANDE);
        return commande;
    }
    ...
    void putNewCommande() throws Exception {
        ...
        updatedCommande.numero(UPDATED_NUMERO).dateCommande(UPDATED_DATE_COMMANDE);
    ...
    void fullUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.numero(UPDATED_NUMERO).dateCommande(UPDATED_DATE_COMMANDE);
