...
import com.diandson.repository.NotificationRepository;
import com.diandson.service.dto.NotificationDTO;
import com.diandson.service.mapper.NotificationMapper;
...
class NotificationResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_DATE_NOTIF = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DATE_NOTIF = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);

    private static final Boolean DEFAULT_VUE = false;
    private static final Boolean UPDATED_VUE = true;
    ...
    void createNotification() throws Exception {
        ...
        assertThat(testNotification.getVue()).isEqualTo(DEFAULT_VUE);
    }
    ...
    void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateNotif").value(hasItem(sameInstant(DEFAULT_DATE_NOTIF))))
            .andExpect(jsonPath("$.[*].vue").value(hasItem(DEFAULT_VUE.booleanValue())));
    }
    ...
    void getNotification() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.dateNotif").value(sameInstant(DEFAULT_DATE_NOTIF)))
            .andExpect(jsonPath("$.vue").value(DEFAULT_VUE.booleanValue()));
    }
    ...
    void putNewNotification() throws Exception {
        ...
        updatedNotification.titre(UPDATED_TITRE).content(UPDATED_CONTENT).dateNotif(UPDATED_DATE_NOTIF).vue(UPDATED_VUE);
        ...
        assertThat(testNotification.getVue()).isEqualTo(UPDATED_VUE);
    }
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.dateNotif(UPDATED_DATE_NOTIF).vue(UPDATED_VUE);
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.titre(UPDATED_TITRE).content(UPDATED_CONTENT).dateNotif(UPDATED_DATE_NOTIF).vue(UPDATED_VUE);
