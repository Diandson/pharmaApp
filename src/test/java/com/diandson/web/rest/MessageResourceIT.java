...
import com.diandson.repository.MessageRepository;
import com.diandson.service.dto.MessageDTO;
import com.diandson.service.mapper.MessageMapper;
...
class MessageResourceIT {
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().message(DEFAULT_MESSAGE).dateMessage(DEFAULT_DATE_MESSAGE).to(DEFAULT_TO).vue(DEFAULT_VUE);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().message(UPDATED_MESSAGE).dateMessage(UPDATED_DATE_MESSAGE).to(UPDATED_TO).vue(UPDATED_VUE);
        return message;
    }
    ...
    void createMessage() throws Exception {
        ...
        assertThat(testMessage.getVue()).isEqualTo(DEFAULT_VUE);
    }
    ...
    void putNewMessage() throws Exception {
        ...
        updatedMessage.message(UPDATED_MESSAGE).dateMessage(UPDATED_DATE_MESSAGE).to(UPDATED_TO).vue(UPDATED_VUE);
        ...
        assertThat(testMessage.getVue()).isEqualTo(UPDATED_VUE);
    }
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.message(UPDATED_MESSAGE).dateMessage(UPDATED_DATE_MESSAGE).to(UPDATED_TO).vue(UPDATED_VUE);
