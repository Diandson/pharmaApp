...
import com.diandson.repository.FournisseurRepository;
import com.diandson.service.dto.FournisseurDTO;
import com.diandson.service.mapper.FournisseurMapper;
...
class FournisseurResourceIT {
    ...
    public static Fournisseur createEntity(EntityManager em) {
        Fournisseur fournisseur = new Fournisseur().libelle(DEFAULT_LIBELLE).email(DEFAULT_EMAIL);
        return fournisseur;
    }
    ...
    public static Fournisseur createUpdatedEntity(EntityManager em) {
        Fournisseur fournisseur = new Fournisseur().libelle(UPDATED_LIBELLE).email(UPDATED_EMAIL);
        return fournisseur;
    }
    ...
    void putNewFournisseur() throws Exception {
        ...
        updatedFournisseur.libelle(UPDATED_LIBELLE).email(UPDATED_EMAIL);
    ...
    void partialUpdateFournisseurWithPatch() throws Exception {
        ...
        partialUpdatedFournisseur.email(UPDATED_EMAIL);
    ...
    void fullUpdateFournisseurWithPatch() throws Exception {
        ...
        partialUpdatedFournisseur.libelle(UPDATED_LIBELLE).email(UPDATED_EMAIL);
